...
namespace Flexa\MailBridge\OAuth;

use Flexa\MailBridge\Support\Encryption;

defined( 'ABSPATH' ) || exit;

/**
 * Encrypted store for OAuth tokens, kept in its own option (`flexa_mailbridge_oauth_tokens`)
...
final class TokenStore {
	public const OPTION_KEY = 'flexa_mailbridge_oauth_tokens';
