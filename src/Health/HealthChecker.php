...
namespace Flexa\MailBridge\Health;

use Flexa\MailBridge\Concerns\HasInstance;
use Flexa\MailBridge\Health\Checks\DnsCheck;
use Flexa\MailBridge\Health\Checks\EnvironmentCheck;
use Flexa\MailBridge\Health\Checks\TransportCheck;
...
final class HealthChecker {
	...
	public const CRON_HOOK = 'flexa_mailbridge_health';
	public const OPTION    = 'flexa_mailbridge_health_report';
	...
	public function checks(): array {
		 ...
		 */
		return apply_filters( 'flexa_mailbridge.health.checks', $checks );
	}
}
