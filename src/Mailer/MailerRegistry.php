...
use Flexa\MailBridge\Mailer\Providers\NativeMailer;
use Flexa\MailBridge\Mailer\Providers\SmtpMailer;
 ...
 * WP3/WP4 providers register through the `flexa_mailbridge.mailers.register` action so
...
final class MailerRegistry {
	...
	private function boot(): void {
		 ...
		 */
		do_action( 'flexa_mailbridge.mailers.register', $this );
	}
}
