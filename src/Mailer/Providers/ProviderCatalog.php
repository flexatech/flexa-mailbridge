...
namespace Flexa\MailBridge\Mailer\Providers;

use Flexa\MailBridge\Concerns\HasInstance;
use Flexa\MailBridge\Mailer\Contracts\ProvidesCredentialSchema;
 ...
 * (`flexa_mailbridge.settings.mailer_schema`) and registers each mailer factory
 * (`flexa_mailbridge.mailers.register`). Adding a provider is a single line here — the
...
final class ProviderCatalog {
	...
	public function register(): void {
		add_filter( 'flexa_mailbridge.settings.mailer_schema', [ $this, 'add_schema' ] );
		add_action( 'flexa_mailbridge.mailers.register', [ $this, 'register_mailers' ] );
	}
