...
namespace Flexa\MailBridge\Tracking;
 ...
 * `flexa_mailbridge.log.created` — fired by {@see \Flexa\MailBridge\Logging\MailLogger} once
...
final class Tracker {
	...
	public function register(): void {
		add_action( 'flexa_mailbridge.log.created', [ $this, 'on_log_created' ], 10, 2 );
	}
