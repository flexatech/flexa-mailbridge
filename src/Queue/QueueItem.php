...
/**
 * One queued message. Immutable view over a `flexa_mailbridge_email_queue` row. The
 * payload column (a full serialized message, see {@see \Flexa\MailBridge\Mailer\PhpMailerBridge::to_payload()})
