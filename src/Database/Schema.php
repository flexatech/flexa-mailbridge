...
namespace Flexa\MailBridge\Database;

defined( 'ABSPATH' ) || exit;

/**
 * Versioned schema migrator for every flexa_mailbridge_* table. Runs on activation
...
final class Schema {
	...
	public const VERSION_OPTION = 'flexa_mailbridge_db_version';
	...
	public static function migrate(): void {
		...
		$schema[] = "CREATE TABLE {$p}flexa_mailbridge_email_logs (
		...
		$schema[] = "CREATE TABLE {$p}flexa_mailbridge_open_events (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
		...
		$schema[] = "CREATE TABLE {$p}flexa_mailbridge_click_events (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
			log_id bigint(20) unsigned NOT NULL,
			url text NOT NULL,
			count int(11) NOT NULL DEFAULT 0,
		...
		$schema[] = "CREATE TABLE {$p}flexa_mailbridge_email_queue (
			id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
