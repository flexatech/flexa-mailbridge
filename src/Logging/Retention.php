 ...
 * window. The cron hook name matches the one {@see \Flexa\MailBridge\Setup\Deactivator}
...
final class Retention {
	...
	public const HOOK = 'flexa_mailbridge_retention';
	...
	public function purge(): int {
		 ...
		 */
		do_action( 'flexa_mailbridge.logs.purged', $removed, $days );
