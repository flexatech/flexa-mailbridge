...
namespace Flexa\MailBridge\Import\Contracts;
 ...
 * onto Flexa MailBridge's own settings schema and log tables.
 */
interface ImporterInterface {
	...
	/**
	 * Read the source's configuration and merge it onto Flexa MailBridge's settings
	 * (through {@see \Flexa\MailBridge\Support\Settings::save()}, so secrets are
