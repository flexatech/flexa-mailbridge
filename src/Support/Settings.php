...
/**
 * Single source of truth for the `flexa_mailbridge_settings` option: the typed schema,
 ...
 * provider (WP3/WP4) extends via the `flexa_mailbridge.settings.mailer_schema` filter.
 */
final class Settings {
	public const OPTION_KEY = 'flexa_mailbridge_settings';
	 ...
	 */
	public const SECRET_MASK = '__flexa_mailbridge_secret__';
	...
	public static function mailer_schema(): array {
		 ...
		 */
		return apply_filters( 'flexa_mailbridge.settings.mailer_schema', $schema );
	}
	...
	public static function save( array $incoming ): array {
		 ...
		 */
		do_action( 'flexa_mailbridge.settings.updated', $new, $old );
