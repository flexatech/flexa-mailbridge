...
final class Capabilities {
	...
	public static function can_manage(): bool {
		return current_user_can( apply_filters( 'flexa_mailbridge.capabilities.manage', self::MANAGE ) );
	}

	public static function can_manage_settings(): bool {
		return current_user_can( apply_filters( 'flexa_mailbridge.capabilities.settings', self::SETTINGS ) );
	}
}
