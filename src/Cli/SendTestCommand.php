...
/**
 * Send a test email through the full Flexa MailBridge pipeline (active mailer, From
 ...
 *
 *     wp flexa-mailbridge test <to> [--subject=<subject>] [--html]
 */
final class SendTestCommand {
	public static function register(): void {
		...
		WP_CLI::add_command( 'flexa-mailbridge test', self::class );
	}
	 ...
	 * ## EXAMPLES
	 *
	 *     wp flexa-mailbridge test you@example.com
	 *     wp flexa-mailbridge test you@example.com --subject="Ping" --html
	 *
	...
	public function __invoke( array $args, array $assoc ): void {
		...
		if ( '' === $subject ) {
			$subject = sprintf(
				'Flexa MailBridge test email from %s',
		...
		$body    = $is_html
			? '<p>This is a Flexa MailBridge test email. If you received it, your mailer is configured correctly.</p>'
			: 'This is a Flexa MailBridge test email. If you received it, your mailer is configured correctly.';
