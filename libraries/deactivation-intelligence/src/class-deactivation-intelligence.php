...
if ( ! class_exists( 'Deactivation_Intelligence' ) ) :
	...
	class Deactivation_Intelligence {
		...
		private function reasons() {
			return array(
				array( 'id' => 'no_longer_needed', 'label' => __( 'I no longer need it', 'flexa-mailbridge' ) ),
				array( 'id' => 'missing_feature', 'label' => __( "It's missing a feature I need", 'flexa-mailbridge' ), 'followup' => 'feature' ),
				array( 'id' => 'broken', 'label' => __( "Something isn't working", 'flexa-mailbridge' ), 'followup' => 'broken' ),
				array( 'id' => 'conflict', 'label' => __( 'It conflicts with another plugin/theme', 'flexa-mailbridge' ), 'followup' => 'conflict' ),
				array( 'id' => 'difficult_to_use', 'label' => __( "It's too difficult to use", 'flexa-mailbridge' ), 'followup' => 'difficult' ),
				array( 'id' => 'performance', 'label' => __( "It's affecting performance", 'flexa-mailbridge' ) ),
				array( 'id' => 'alternative', 'label' => __( 'I found a better alternative', 'flexa-mailbridge' ), 'followup' => 'alternative' ),
				array( 'id' => 'troubleshooting', 'label' => __( "I'm troubleshooting", 'flexa-mailbridge' ) ),
				array( 'id' => 'other', 'label' => __( 'Other', 'flexa-mailbridge' ), 'followup' => 'other' ),
			);
		}
		...
		private function strings() {
			return array(
				'title'           => __( 'Before you go…', 'flexa-mailbridge' ),
				'subtitle'        => __( 'What made you deactivate this plugin?', 'flexa-mailbridge' ),
				'skip'            => __( 'Skip & deactivate', 'flexa-mailbridge' ),
				'cancel'          => __( 'Cancel', 'flexa-mailbridge' ),
				'submit'          => __( 'Deactivate', 'flexa-mailbridge' ),
				'deactivateAnyway'=> __( 'Deactivate anyway', 'flexa-mailbridge' ),
				'getHelp'         => __( 'Get help', 'flexa-mailbridge' ),
				'notify'          => __( 'Notify me if you add it', 'flexa-mailbridge' ),
				'featureQ'        => __( 'What feature are you looking for?', 'flexa-mailbridge' ),
				'brokenQ'         => __( 'What went wrong?', 'flexa-mailbridge' ),
				'conflictQ'       => __( 'Which plugin or theme is it conflicting with?', 'flexa-mailbridge' ),
				'difficultQ'      => __( 'What was difficult to use?', 'flexa-mailbridge' ),
				'alternativeQ'    => __( 'What alternative are you using?', 'flexa-mailbridge' ),
				'otherQ'          => __( 'Anything you would like to share?', 'flexa-mailbridge' ),
				'optional'        => __( 'Optional', 'flexa-mailbridge' ),
			);
		}
	}
