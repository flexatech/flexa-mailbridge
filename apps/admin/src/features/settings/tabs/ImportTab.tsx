    ...
    return (
        <div className="fs:p-5">
            <p className="fs:mb-4 fs:text-sm fs:text-slate-600">
                {__(
                    "Migrate your configuration and email logs from another SMTP plugin. Importing settings merges over your current Flexa MailBridge settings; secrets are re-encrypted on import.",
                )}
            </p>
