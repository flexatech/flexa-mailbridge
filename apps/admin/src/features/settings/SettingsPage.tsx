...
const SECTIONS: SectionMeta[] = [
  {
    ...
    paneTitle: __("Dashboard"),
    paneSubtitle: __(
      "Your email health, activity, and recent sends in one place.",
    ),
  },
  {
    id: "overview",
    title: __("Health check"),
    subtitle: __("Deliverability questions"),
    icon: Stethoscope,
    paneTitle: __("Health check"),
  ...
  },
  {
    ...
    paneSubtitle: __(
      "Send email in the background and retry temporary failures.",
    ),
  },
  {
    id: "logs",
  ...
  return (
    <div className="fs:min-h-full fs:bg-slate-50">
      ...
      <div className="fs:border-b fs:border-slate-200 fs:bg-white">
        <div className="fs:mx-auto fs:flex fs:max-w-none fs:items-center fs:gap-4 fs:px-6 fs:py-3">
      ...
      <div className="fs:mx-auto fs:flex fs:max-w-none fs:flex-wrap fs:items-start fs:justify-between fs:gap-4 fs:px-6 fs:pt-8 fs:pb-6">
        <div className="fs:space-y-1">
          ...
          <p className="fs:text-sm fs:text-slate-600">
            {__("Configure how WordPress sends, logs, and tracks email.")}
          </p>
        </div>
        {showSave && (
      ...
      {/* Body: nav + pane */}
      <div className="fs:mx-auto fs:flex fs:max-w-none fs:flex-col fs:gap-6 fs:px-6 fs:pb-12 fs:md:flex-row">
